...
for ii = 1:ds.n
    ...
    mesh_scale = array2table(ds.shape{ii}.scale * 10, ...
        'VariableNames', {'Scale'});
    writetable(mesh_scale, [ds.msc.mesh_aligned_dir ds.names{ii}, '_scale.csv']); %Scale appears to be off by a decimal place.
