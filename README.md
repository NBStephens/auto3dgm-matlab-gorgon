...
This is a fork of the auto3dgm MATLAB package PuenteAlignment. The aim of this fork is to provide improved user experience and to add additional functionality both upstream and downstream from the core auto3dgm workflow. This package is under active development and the latest version can be found in the dev branch. The master branch of this repository will eventually contain stable milestone releases, but currently it is basically identical to the original repository.
